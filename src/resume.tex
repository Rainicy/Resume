...
\contact{Bingyu Wang}
{(617) 750-6151 $\bullet$ rainicy@me.com $\bullet$ bingyuwang.net}
{104 Queensberry St. APT 16, Boston, MA, 02215}

\header{Education}
\headerrow
{\textbf{Northeastern University, Boston, MA} \emph{PhD of Computer Science,\;\;\;\; GPA: 3.86/4.00}}
{\emph{2015-Present}}
...
% \headerrowwf
% {---\textbf{Core Courses}:
% Machine Learning  $\cdot$ Data Mining $\cdot$  Algorithms $\cdot$  Information Theory }
% {\emph{}}
...
\headerrow
{\textbf{Northeastern University, Boston, MA} \emph{Master of Computer Science, GPA: 3.86/4.00}}
{\emph{2012 - 2014}}
% {\text{Xi'an, China}}
\\
\headerrowwf
{\textbf{Northwest University, Xi'an, China} \emph{\;\;\; BE in Software Engineering, \;GPA: 3.30/4.00}}
{\emph{2008 - 2012}}
...
% \header{Publications}
% \headerrow
% {\textit{\textbf{Wang}, Li, Pavlu, Aslam} ``A Pipeline for Optimizing F1-Measure in Multi-Label Text Classification''} {\emph{ICMLA 2018}}
% \headerrow
